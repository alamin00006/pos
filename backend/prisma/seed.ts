...
const PERMISSIONS = [
  ...
  { key: 'add_expense_category', name: 'Add Expense Category', module: 'Expense Category' },
  ...
  { key: 'bank_account_delete', name: 'Bank Account Delete', module: 'Bank Account' },
  { key: 'bank_account_list', name: 'Bank Account List', module: 'Bank Account' },
  { key: 'bank_account_transfer', name: 'Bank Account Transfer', module: 'Bank Account' },
  { key: 'bank_account_withdraw', name: 'Bank Account Withdraw', module: 'Bank Account' },
  ...
  { key: 'category_wise_report', name: 'Category Wise Report', module: 'Report' },
  { key: 'change_password', name: 'Change Password', module: 'Profile' },
  { key: 'create_assets', name: 'Create Assets', module: 'Assets' },
  { key: 'create_bank_deposit', name: 'Create Bank Deposit', module: 'Bank Account' },
  ...
  { key: 'create_expense_category', name: 'Create Expense Category', module: 'Expense Category' },
  ...
  { key: 'current_month_expense', name: 'Current Month Expense', module: 'Dashboard' },
  { key: 'current_month_profit', name: 'Current Month Profit', module: 'Dashboard' },
  { key: 'current_month_purchase', name: 'Current Month Purchase', module: 'Dashboard' },
  { key: 'current_month_report', name: 'Current Month Report', module: 'Report' },
  { key: 'current_month_return', name: 'Current Month Return', module: 'Dashboard' },
  { key: 'current_month_sold', name: 'Current Month Sold', module: 'Dashboard' },
  { key: 'customer_due_report', name: 'Customer Due Report', module: 'Report' },
  { key: 'customer_ledger', name: 'Customer Ledger', module: 'Customer' },
  { key: 'customer_ledger_report', name: 'Customer Ledger Report', module: 'Report' },
  { key: 'customer_make_payment', name: 'Customer Make Payment', module: 'Customer' },
  ...
  { key: 'delete_expense_category', name: 'Delete Expense Category', module: 'Expense Category' },
  ...
  { key: 'edit_expense_category', name: 'Edit Expense Category', module: 'Expense Category' },
  ...
  { key: 'product_add_category', name: 'Product Add Category', module: 'Product' },
  { key: 'profile', name: 'Profile', module: 'Profile' },
  { key: 'profit_loss_report', name: 'Profit Loss Report', module: 'Report' },
  { key: 'promotional_sms', name: 'Promotional SMS', module: 'Promotional Sms' },
  { key: 'purchase_add_payment', name: 'Purchase Add Payment', module: 'Purchase' },
  { key: 'purchase_add_supplier', name: 'Purchase Add Supplier', module: 'Purchase' },
  ...
  { key: 'sales_purchase_chart', name: 'Sales Purchase Chart', module: 'Dashboard' },
  ...
  { key: 'supplier_ledger_report', name: 'Supplier Ledger Report', module: 'Report' },
  { key: 'supplier_make_payment', name: 'Supplier Make Payment', module: 'Supplier' },
  ...
  { key: 'top_product_all_time_report', name: 'Top Product All Time Report', module: 'Report' },
...
async function main() {
  ...
  const adminRole = await prisma.role.upsert({
    where: { name: 'ADMIN' },
    update: {},
    create: { name: 'ADMIN', description: 'Administrator with full access', isSystem: true },
  });

  const staffRole = await prisma.role.upsert({
    where: { name: 'STAFF' },
    update: {},
    create: { name: 'STAFF', description: 'Staff member with limited access', isSystem: true },
  });

  const cashierRole = await prisma.role.upsert({
    where: { name: 'CASHIER' },
    update: {},
    create: { name: 'CASHIER', description: 'Cashier for POS operations', isSystem: true },
  });
  ...
  const posPermissions = allPermissions.filter((p) => p.module === 'POS' || p.module === 'Customer' || p.module === 'Product');
  ...
  const adminUser = await prisma.user.upsert({
    ...
    update: {},
    create: { email: 'admin@softghor.com', password: hashedPassword, name: 'Admin User', phone: '01700000000' },
  });
  ...
  const unit = await prisma.unit.upsert({ where: { name: 'Piece' }, update: {}, create: { name: 'Piece', shortName: 'pc' } });
  const brand = await prisma.brand.upsert({ where: { name: 'Generic' }, update: {}, create: { name: 'Generic' } });
  const category = await prisma.category.upsert({ where: { name: 'Electronics' }, update: {}, create: { name: 'Electronics', code: 'ELEC' } });
  ...
  const supplier = await prisma.supplier.upsert({
    ...
    update: {},
    create: { id: 'seed-supplier-1', name: 'ABC Suppliers', phone: '01711111111', email: 'abc@supplier.com' },
  });

  const customer = await prisma.customer.upsert({
    where: { id: 'seed-customer-1' },
    update: {},
    create: { id: 'seed-customer-1', name: 'Walk-in Customer', phone: '01722222222' },
  });
