...
__decorate([
    (0, common_1.Post)(),
    (0, decorators_1.Permissions)('employee_salary'),
...
__decorate([
    (0, common_1.Get)(),
    (0, decorators_1.Permissions)('employee_salary'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all salary payments' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, decorators_1.Permissions)('employee_salary'),
    (0, swagger_1.ApiOperation)({ summary: 'Get salary payment by ID' }),
