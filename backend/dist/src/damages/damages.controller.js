...
__decorate([
    (0, common_1.Post)(),
    (0, decorators_1.Permissions)('add_damage'),
    (0, swagger_1.ApiOperation)({ summary: 'Create damage record' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateDamageDto]),
    __metadata("design:returntype", void 0)
], DamagesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, decorators_1.Permissions)('view_damage'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all damages' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, decorators_1.Permissions)('view_damage'),
    (0, swagger_1.ApiOperation)({ summary: 'Get damage by ID' }),
...
__decorate([
    ...
    (0, decorators_1.Permissions)('delete_damage'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete damage' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
